...
// # Approach
//
// Open one RocksDB instance under <datadir>/database/ with the 17 column
...
// backward-sync / snap-sync / chain-pruner CFs, which stay empty but make
// the layout match a Besu-initialized DB). Stream synthetic accounts through a temp
